...
\cventry{2021 -- present}{Senior ML Engineer}{Snapp!}{Tehran, Iran}{}{
      \begin{itemize}[label=\textbullet]
            ...
            \item Completed \textbf{EDA} on data and shared dataset of Tehran rides to 4 smaller shards, trained a model for each shard but could reduce models' size and increase their accuracy.
...
\cventry{2021 -- present}{Senior ML Engineer}{Snapp!}{Tehran, Iran}{}{
      \begin{itemize}[label=\textbullet]
            \item Employed \textbf{Streamlit} for my model for better communication with product team.
...
\cventry{2018 -- 2020}{ML Engineer}{Avidnet Technology}{Tehran, Iran}{}{
      ...
      \begin{itemize}[label=\textbullet]
            ...
            \item Kept track of the places a person spends time on a regular basis and name them.
            ...
            \item Made data compatible with GDPR before storing it.
            ...
            \item Helped the frontend team to develop related components using \textbf{Typescript} and \textbf{React}
      \end{itemize}
}
