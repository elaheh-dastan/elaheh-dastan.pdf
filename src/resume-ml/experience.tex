...
\cventry{Jul 2024 -- present}{Senior Data Scientist}{Digikala}{Tehran, Iran}{}{
      \begin{itemize}[label=\textbullet]
        ...
        \item Trained model to be \textbf{multilingual}.
        \item Trained a \textbf{Query Understanding (QU)} model leveraging user query logs and click data to infer user intent and reformulate low-confidence queries, reducing zero-result searches by \textbf{4\%}.
