...
\cventry{2020 -- 2021}{ML Engineer}{Snapp!}{Tehran, Iranhttps://github.com/JaidedAI/EasyOCR}{}{
      \vspace{.4cm}
      \begin{itemize}[label=\textbullet]
            \item Developed a CRF-based model for NER that assisted our search engine to increase succesful searches by 15%. 
            \item Implemented Content-Based Filtering for ride suggestions to passengers, resulting in a 30\% reduction in app search time.
            ...
            \item Employed \textbf{ONNX} to \textbf{increase inference speed by 10\%} on our large language models.
