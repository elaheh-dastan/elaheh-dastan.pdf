...
\cventry{Jul 2024 -- present}{Senior Data Scientist}{Digikala}{Tehran, Iran}{}{
      \begin{itemize}[label=\textbullet]
        ...
        \item Trained a Query Understanding (QU) model leveraging user query logs and click data to prune low-confidence queries, reducing zero-click searches by \textbf{4\%}.
        \item Improved search relevance via multi-metric fine-tuning and category-consistent retrieval using Category Loss and GMV-weighted balancing, boosting CR by \textbf{4\%}.
