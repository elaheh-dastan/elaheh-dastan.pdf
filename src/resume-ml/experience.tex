...
\cventry{Jul 2024 -- present}{Senior Data Scientist}{Digikala}{Tehran, Iran}{}{
      \begin{itemize}[label=\textbullet]
        \item Develop a \textbf{data augmentation pipeline} for a semantic search system to enhance robustness and support diverse languages, synonyms, and other variations.
        \item Train a \textbf{semantic search} model utilizing \textbf{CLIP} with \textbf{Cross-Entropy} as the Loss function.
      \end{itemize}
      \textbf{Skills:}
}
...
\cventry{2021 -- 2024}{Senior ML Engineer}{Snapp!}{Tehran, Iran}{}{
      \begin{itemize}[label=\textbullet]
            \item Built a \textbf{recommendation system} to recommend speed for streets that don't have sufficient data which \textbf{improved coverage from one million shard streets to 3 millions}.
            ...
            \item Collaborated with product to \textbf{clustered} Iran cities from over 40 down to 10 which helped in reducing number of models.
