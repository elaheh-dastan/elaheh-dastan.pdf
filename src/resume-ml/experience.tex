...
\cventry{Jul 2024 -- present}{Senior Data Scientist}{Digikala}{Tehran, Iran}{}{
      \begin{itemize}[label=\textbullet]
        ...
        \item \textbf{LLM-based Data Augmentation:} Designed \textbf{Claude-powered} query variation generation to improve generalization and long-tail recall, leading to measurable gains in semantic model robustness.
        \item \textbf{Exact Match Retrieval:} Led the \textbf{Exact Match project} to enable precise product code recognition (e.g., “mirror code 10”) by implementing tokenizer modifications, custom masking, and a \textbf{Redis-based code index}, resulting in significant Add-to-Cart improvements.
        \item \textbf{Real-Time Adaptation:} Investigated \textbf{live feedback loops} using user engagement signals and evaluated \textbf{ANCE (Approximate Nearest Contrastive Learning)} for real-time embedding updates.
        \item \textbf{Personalized Search via User Segmentation:} Built scalable user segmentation using \textbf{embedding-based}, \textbf{feature-driven}, and \textbf{clustering} techniques; improved conversion rate by \textbf{5\%} through iterative class refinement and premium user targeting.
        \item \textbf{Analytical Engineering Approach:} Compared Semantic BA and Elastic Search pipelines across top queries to guide metric alignment, offline evaluation, and production deployment decisions with an emphasis on quantitative rigor.
      \end{itemize}
