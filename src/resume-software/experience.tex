...
\begin{itemize}
      \item Keep track of the places a person spends time on a regular basis, naming and predicting where the person should be in a 30 minute time bucket and alert otherwise.
      ...
      \item Launch a \textbf{Kafka} pipeline to gather data from sensors using \textbf{Protobuf} and
            then stores them into \textbf{DataLake} and capable of handling +20k messages per second.
