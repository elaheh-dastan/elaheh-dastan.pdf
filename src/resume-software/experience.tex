...
\cventry{Tehran, Iran}{Platform Engineer}{Snapp!}{Feb 2023 -- present}{}{}
\begin{itemize}
...
\cventry{Tehran, Iran}{Software Engineer}{Snapp!}{Aug 2020 -- Feb 2023}{}{}
\begin{itemize}
...
\cventry{Tehran, Iran}{Software Engineer}{Avidnet Technology}{Jan 2018 -- Aug 2020}{}{}
\begin{itemize}
      ...
      \item Provided in-application video call solution using \textbf{WebRTC} based on \textbf{Pion} Framework which \textbf{increased application installation rate by 5\%} and can handle \textbf{1K concurrent calls} on out distributed design.
\end{itemize}
