...
\begin{itemize}
      ...
      \httpslink[\textbf{Seldon}]{www.seldon.io} which reduced ML models response time by 15\%
            with help of request batching and Protobuf protocol.
      \item Set up Kafka on Kubernetes using \httpslink[\textbf{Strimzi}]{strimzi.io} operator and maintain it to handle +300k
