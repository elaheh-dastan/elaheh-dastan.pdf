...
\cventry{Feb 2023 -- present}{Platform Engineer}{Snapp!}{Tehran, Iran}{}{
      ...
      \begin{itemize}[label=\textbullet]
            ...
            \item Configure NATS on Red Hat OpenShift Service on AWS (\textbf{ROSA})
                  using Helm charts to lower costs \textbf{10\%} by deprecating Amazon Simple Queue Service (\textbf{SQS}).
...
\cventry{Aug 2020 -- Feb 2023}{Software Engineer}{Snapp!}{Tehran, Iran}{}{
      ...
      \begin{itemize}[label=\textbullet]
            ...
            \item Architected and maintained Golang services for \textbf{real time} order processing, implementing microservices for \textbf{geofencing} and
                  geospatial indexing using \httpslink[\textbf{Tile38}]{tile38.com}; reached \textbf{sub-millisecond response times} and
            ...
            \item Designed and optimized databases using \textbf{PostgreSQL} and \textbf{MongoDB} which reduced response time of 3 services by \textbf{30\%}.
      \end{itemize}
}
