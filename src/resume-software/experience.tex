...
\cventry{Feb 2023 -- present}{Platform Engineer}{Snapp!}{Tehran, Iran}{}{
      ...
      \begin{itemize}[label=\textbullet]
            \item Directed the design of a scalable, microservice based architecture, harnessing the power of
                  \httpslink[\textbf{NATS}]{nats.io} as the primary message-passing system,
...
\cventry{Aug 2020 -- Feb 2023}{Software Engineer}{Snapp!}{Tehran, Iran}{}{
      ...
      \begin{itemize}[label=\textbullet]
            \item Optimized driver location collector (written in \textbf{PHP}) by migrating into a modern platform, re-written in \textbf{Go} and cloud infrastructure,
                  increasing availability by \textbf{20\%} and facilitating faster rollout of new functionalities.
